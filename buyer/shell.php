...
function pageDiv(n,t,u,x){
  if(cntrlIsPressed){
    ...
    $("#mainDiv").html('<div id="mydiv"><img src="/buyer/divPage6.html" class="ajax-loader"></div>').show();
    $.ajax({
    type:       'GET',
    url:        'divPage6.html',
    success:    function(data)
						...
						<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
							...
							<a class="dropdown-item waves-effect waves-light" href="cPanel" style="color: var(--font-color);">
								<span class="px-2">
									...
									cPanels
									<span class="badge badge-primary">15502</span>
								</span>
							</a>
							<a class="dropdown-item waves-effect waves-light" href="shell" style="color: var(--font-color);">
								<span class="px-2">
									...
									Shells
									<span class="badge badge-primary">1105</span>
								</span>
							</a>
						...
						<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
							<a class="dropdown-item waves-effect waves-light" href="premium_shell" style="color: var(--font-color);">
								<span class="px-2">
									...
									Premium Shells
									<span class="badge badge-primary">979</span>
								</span>
							</a>
						...
						<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
							<a class="dropdown-item waves-effect waves-light" href="mailer" style="color: var(--font-color);">
								<span class="px-2">
									<i class="fas fa-leaf fa-fw"></i>
									Mailers
									<span class="badge badge-primary">401</span>
								</span>
							</a>
