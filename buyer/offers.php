            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown mr-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="cPanel" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-tools fa-fw"></i> cPanels <span class="badge badge-primary">15388</span></span></a>
                        <a class="dropdown-item" href="shell" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-file-code fa-fw"></i> Shells <span class="badge badge-primary">1142</span></span></a>
                ...
                <li class="nav-item dropdown mr-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="premium_cPanel" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-leaf fa-fw"></i> Premium cPanels <span class="badge badge-primary">5590</span></span></a>
...
<div>
    ...
    <script>
        ...
        function opendell(id) {
            $("#idresc").val(id);
            $('#modalConfirmBuy').modal('show');
        }
 
        function addsubmit() {
            var idresc = $("#idresc").val();
            $.ajax({
                type: "POST",
                url: "addoffer",
                dataType: "json",
                ...
                success: function(response) {
                    if (response.success == 1) {
                        window.location.href = "offer-" + idresc;
    ...
    <div class="modal fade" id="modalConfirmBuy" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-sm modal-notify modal-info" role="document">
            <div class="modal-content text-center">
                <input type="hidden" id="idresc" required="">
                ...
                <div class="modal-footer flex-center">
                    <a onClick='addsubmit()' class="btn btn-outline-info waves-effect" data-dismiss="modal">Yes</a>
