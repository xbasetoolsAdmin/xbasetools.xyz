						...
						<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
							...
							<a class="dropdown-item" href="cPanel" style="color: var(--font-color);">
								<span class="px-2">
									...
									cPanels
									<span class="badge badge-primary">16504</span>
								</span>
							</a>
							<a class="dropdown-item" href="shell" style="color: var(--font-color);">
								<span class="px-2">
									...
									Shells
									<span class="badge badge-primary">822</span>
								</span>
							</a>
						...
						<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="premium_shell" style="color: var(--font-color);">
								<span class="px-2">
									...
									Premium Shells
									<span class="badge badge-primary">960</span>
								</span>
							</a>
							<a class="dropdown-item" href="premium_cPanel" style="color: var(--font-color);">
								<span class="px-2">
									<i class="fas fa-leaf fa-fw"></i>
									Premium cPanels
									<span class="badge badge-primary">5457</span>
								</span>
							</a>
						...
						<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
							...
							<a class="dropdown-item" href="smtp" style="color: var(--font-color);">
								<span class="px-2">
									...
									SMTPs
									<span class="badge badge-primary">2004</span>
								</span>
							</a>
						</div>
					</li>
						...
						<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="business-1" style="color: var(--font-color);">
								<span class="px-2">
									...
									cPanel Webmail
									<span class="badge badge-primary">6163</span>
								</span>
							</a>
							<a class="dropdown-item" href="business-2" style="color: var(--font-color);">
								<span class="px-2">
									...
									Godaddy Webmail
									<span class="badge badge-primary">2230</span>
								</span>
							</a>
							<a class="dropdown-item" href="business-3" style="color: var(--font-color);">
								<span class="px-2">
									...
									Office365 Webmail
									<span class="badge badge-primary">9768</span>
								</span>
							</a>
									...
									<div class="row">
										<div class="col-md-8">
											<div class="card mb-3" style="color: var(--font-color); background-color: var(--color-card);">
												<div class="card-header">
													...
													Welcome
													<a class="badge badge-pill badge-success">hustlersfather</a>
													<br>
												</div>
										...
										<div class="col-md-4">
																		...
																		<div class="scrollbar-container ps--active-y" style="color: var(--font-color); background-color: var(--color-card);">
																			<ul class="list-group list-group-flush" style="color: var(--font-color); background-color: var(--color-card);">
																				<li class="list-group-item" style="color: var(--font-color); background-color: var(--color-card);">
																					...
																					To
																					<b>Buyer17589</b>, 2023-05-15 16:13:40
																				</li>
																				<li class="list-group-item" style="color: var(--font-color); background-color: var(--color-card);">
																					<b>Seller376</b>
																					Sold
																					...
																					To
																					<b>Buyer17589</b>, 2023-05-15 16:07:44
																				</li>
																				<li class="list-group-item" style="color: var(--font-color); background-color: var(--color-card);">
																					<b>Seller376</b>
																					Sold
																					...
																					To
																					<b>Buyer17589</b>, 2023-05-15 16:06:03
																				</li>
																				<li class="list-group-item" style="color: var(--font-color); background-color: var(--color-card);">
																					<b>Seller341</b>
																					Sold
																					...
																					To
																					<b>Buyer17589</b>, 2023-05-15 16:04:43
																				</li>
																				<li class="list-group-item" style="color: var(--font-color); background-color: var(--color-card);">
																					<b>Seller376</b>
																					Sold
																					...
																					To
																					<b>Buyer17589</b>, 2023-05-15 15:57:11
																				</li>
																				<li class="list-group-item" style="color: var(--font-color); background-color: var(--color-card);">
																					<b>Seller254</b>
																					Sold
																					...
																					To
																					<b>Buyer17589</b>, 2023-05-15 15:54:24
																				</li>
																				<li class="list-group-item" style="color: var(--font-color); background-color: var(--color-card);">
																					<b>Seller397</b>
																					Sold
																					<font color="green">
																						<b>
																							<a class="text-success" href="business-1">Cpanel Webmail</a>
																						</b>
																					</font>
																					To
																					<b>Buyer17161</b>, 2023-05-15 15:54:09
																				</li>
																				<li class="list-group-item" style="color: var(--font-color); background-color: var(--color-card);">
																					<b>Seller376</b>
																					Sold
																					...
																					To
																					<b>Buyer17589</b>, 2023-05-15 15:44:57
																				</li>
																				<li class="list-group-item" style="color: var(--font-color); background-color: var(--color-card);">
																					<b>Seller376</b>
																					Sold
																					...
																					To
																					<b>Buyer17589</b>, 2023-05-15 15:33:50
																				</li>
																				<li class="list-group-item" style="color: var(--font-color); background-color: var(--color-card);">
																					<b>Seller376</b>
																					Sold
																					...
																					To
																					<b>Buyer17589</b>, 2023-05-15 15:31:07
																				</li>
																			</ul>
																		</div>
																	</div>
											...
											<div class="card mb-3" style="color: var(--font-color); background-color: var(--color-card);">
												...
												<div class="card-footer small text-primary" style="color: var(--font-color); background-color: var(--color-card);">Page Loaded in 1.0701 Seconds</div>
											</div>
										</div>
									</div>
								</div>
...
s0.parentNode.insertBefore(s1,s0);
	            ...
	            var myPieChart = new Chart(ctx, {
	              type: 'pie',
	              data: {
	                labels: ['cPanels [16504]','Leads [243]','Shells [822]','RDPs [73]','Mailers [331]','Scripts [3]', 'Tutorials [1]', 'Accounts [1640]', 'SMTPs [2004]', 'Webmails [19983]', 'FTPs [96]', 'SSH [133]'],
	                datasets: [{
	                  data: ['16504','243','822','73','331','3','1', '1640','2004','19983', '96', '133'],
