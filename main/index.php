...
<script type="text/javascript" src="layoutjs/jquery.js?1"></script>
<script type="text/javascript" src="layout/bootstrap.min.js?1"></script>
...
<link rel="shortcut icon" href="layoutimg/favicon.ico" />
...
function pageDiv(n,t,u,x){
  if(cntrlIsPressed){
    ...
    $("#mainDiv").html('<div id="mydiv"><img src="layoutimg/load2.gif" class="ajax-loader"></div>').show();
    $.ajax({
    type:       'GET',
    url:        'divPage'+n+'.html',
    success:    function(data)
